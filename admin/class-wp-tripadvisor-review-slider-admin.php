...
class WP_TripAdvisor_Review_Admin {
	...
	public function wptripadvisor_tripadvisor_section_developers_cb($args)
	{
		...
		echo "<p>Use this page to download your TripAdvisor business reviews and save them in your Wordpress database. They will show up on the Review List page once downloaded. New reviews are downloaded once a day.</p>";
	}
